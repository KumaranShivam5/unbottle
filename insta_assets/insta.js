(function() {
    ...
    __d(function(g, r, i, a, m, e, d) {
        ...
        function w(s, l) {
            ...
            y = y.replace(j, k), h.ci = u, p(function(t) { h.os = t }), f(function(t, n) { h.ls = t, h.le = n });
                ...
                case i(d[0]).MOUNTED:
                    {
                        ...
                        b(c),
                        p(function(t) { K[c] && (K[c].contentLoaded = t, window.__igEmbedLoaded && window.__igEmbedLoaded({ frameId: c, stats: K[c] })) });
                        break
                    }
                case i(d[0]).LOADING:
                    p(function(t) { K[c] && (K[c].contentLoading = t) });
                    break;
                case i(d[0]).MEASURE:
        ...
        function N() {
            ...
            i(d[2])(() => { y(), J || (i(d[3]).add(window, 'message', h.bind(this)), J = !0) })
        }
